# @xassist/xassist-aggregator
Add aggregatefunctions for arrays to javascript
## Installation

If you use [NPM](https://www.npmjs.com/), you can install the module via `npm install xassist-aggregator`. Otherwise, you can download the latest [minified file](https://github.com/GregBee2/xassist-aggregator.git). Be aware any dependencies are not installed by default; you should consider downloading them yourself.
